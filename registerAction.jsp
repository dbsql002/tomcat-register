...
// 데이터베이스 연결 정보
// 데이터베이스 연결 정보
String url = "jdbc:mariadb://ksh-aws-rds.ctiqo8cs0wya.ap-northeast-2.rds.amazonaws.com/cloud_air"; // RDS 엔드포인트로 변경된 데이터베이스 URL
...
try {
    ...
    if (rowsAffected > 0) {
        // 회원가입 성공
        out.println("<script type='text/javascript'>alert('회원가입에 성공했습니다. 로그인 페이지로 이동합니다.');location.href='/login';</script>");
    } else {
        // 회원가입 실패
